...
import com.example.a15017381.smsretriever.R;
...
public class FragmentSecond extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnEmail = (Button) view.findViewById(R.id.btnEmailFrag2);
        tvSMS = (TextView) view.findViewById(R.id.tvFrag2);

        btnEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] TO = new String[]{"jason_lim@rp.edu.sg"};
                Intent emailIntent = new Intent(Intent.ACTION_SEND);
                emailIntent.setData(Uri.parse("mailto:"));
                emailIntent.setType("text/plain");

                emailIntent.putExtra(Intent.EXTRA_EMAIL, TO);
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, "SMS CONTENT");
                emailIntent.putExtra(Intent.EXTRA_TEXT, tvSMS.getText().toString());
                try {
